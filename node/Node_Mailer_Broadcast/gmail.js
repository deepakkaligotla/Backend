...
const mailer = require('./gmail_config')
...
router.post('/send_email_from_gmail', (req, res) => {
...
router.post('/send_email_with_attachments_from_gmail', upload.array('attachments', 10), async (req, res) => {
  console.log(req.body);
